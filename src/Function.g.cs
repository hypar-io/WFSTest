...
namespace WFSTest
{
    public class Function
    {
        ...
        private IModelStore<WFSTestInputs> store;

        public async Task<WFSTestOutputs> Handler(WFSTestInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<WFSTestInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<WFSTestInputs,WFSTestOutputs>(store, WFSTest.Execute);
